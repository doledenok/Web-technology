...
import ru.doledenok.webtech.DAO.GenericDAO;
...
@Repository
public abstract class GenericDAOImpl<T extends GenericEntity<ID>, ID extends Serializable> implements GenericDAO<T, ID> {
